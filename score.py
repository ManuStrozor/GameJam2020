...
class Score:
    ...
    def update(self):
        ...
        self.player_oxygen_bottle = self.score_font.render("Bouteille d'Oxygène : "+str(self.game.player.oxygen_bottle), True, pygame.Color("lightblue"), pygame.Color("black"))
    ...
    def draw(self):
        ...
        self.game.window.blit(self.player_oxygen_bottle, (5, 40))
        self.game.window.blit(self.player_room, (self.game.window.get_width()/1.2, self.game.window.get_height()/20))
        self.game.window.blit(self.player_chaussure, (5, 80))
